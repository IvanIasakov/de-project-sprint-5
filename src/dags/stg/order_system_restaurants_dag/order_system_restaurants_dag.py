...
def sprint5_example_stg_order_system_restaurants():
    ...
    def load_restaurants(tNam:str):
        ...
        loader.run_copy(tNam)

    restaurant_loader = load_restaurants("restaurants")
    user_loader = load_restaurants("users")
    order_loader = load_restaurants("orders")
