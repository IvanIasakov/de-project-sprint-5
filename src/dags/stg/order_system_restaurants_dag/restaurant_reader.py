...
class RestaurantReader:
    ...
    def get_restaurants(self, load_threshold: datetime, limit, cNam: str) -> List[Dict]:
        ...
        docs = list(self.dbs.get_collection(cNam).find(filter=filter, sort=sort, limit=limit))
        return docs
